...
#define VM_RETAIN_ON_EXEC BIT(VM_HIGH_ARCH_BIT_6) /* vma memory retain on exec */
#else
...
extern void set_retain_memory_vma(struct mm_struct *old_mm, struct mm_struct *mm);
